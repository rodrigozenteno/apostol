...
<h3>Formulario para registro de grados</h3>
@endsection
...
@section('content')
    {!! Form::open(['route' => 'grados.store', 'method' => 'post']) !!}
        ...
        <div class="form-group">
            ...
            {{ Form::text('grado', null, ['placeholder' => 'GENERAL DE EJÉRCITO', 'class' => 'form-control', 'required', 'style' => 'text-transform:uppercase', 'onkeyup' =>'javascript:this.value=this.value.toUpperCase()']) }}
            @error('grado')
            <small>* {{$message}}</small>
            <br>
            @enderror
        ...
        <div class="form-group">
            ...
            {{ Form::text('abreviacion', null, ['placeholder' => 'GRAL. EJTO.', 'class' => 'form-control', 'required', 'style' => 'text-transform:uppercase', 'onkeyup' =>'javascript:this.value=this.value.toUpperCase()']) }}
            @error('abreviacion')
            <small>* {{$message}}</small>
            <br>
            @enderror
